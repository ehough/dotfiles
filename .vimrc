...
" in insert mode you would start a new line by ending the current one by inserting CTRL-J or CTRL-M - and in command
" mode you'd "open" a new line with either 'o' or 'O' for below or above the current line, respectively. By the way,
" "autoindent" is actually a feature of vanilla vi.
